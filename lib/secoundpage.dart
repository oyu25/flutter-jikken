    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          CustomButton(
            onPressed: () => navigateToQuizPage(context, 'や～よ', 'Quiz7.json', 10),
            buttonName: 'や～よ',
          ),
          CustomButton(
            onPressed: () => navigateToQuizPage(context, 'ら～ろ', 'Quiz8.json', 10),
            buttonName: 'ら～ろ',
          ),
          CustomButton(
            onPressed: () => navigateToQuizPage(context, 'わ～ん', 'Quiz9.json', 10),
            buttonName: 'わ～ん',
          ),
        ],
      ),
